...
namespace WebApplication1.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/IsExist", ReplyAction="http://tempuri.org/IService1/IsExistResponse")]
        System.Threading.Tasks.Task<bool> IsExistAsync(string name);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/getCodeByName", ReplyAction="http://tempuri.org/IService1/getCodeByNameResponse")]
        int getCodeByName(string name);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/getCodeByName", ReplyAction="http://tempuri.org/IService1/getCodeByNameResponse")]
        System.Threading.Tasks.Task<int> getCodeByNameAsync(string name);
    }
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<WebApplication1.ServiceReference1.IService1>, WebApplication1.ServiceReference1.IService1 {
        ...
        public bool IsExist(string name) {
            return base.Channel.IsExist(name);
        }
        
        public System.Threading.Tasks.Task<bool> IsExistAsync(string name) {
            return base.Channel.IsExistAsync(name);
        }
        
        public int getCodeByName(string name) {
            return base.Channel.getCodeByName(name);
        }
        
        public System.Threading.Tasks.Task<int> getCodeByNameAsync(string name) {
            return base.Channel.getCodeByNameAsync(name);
        }
    }
}
