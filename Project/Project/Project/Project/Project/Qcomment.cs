...
namespace Project
{
    class Qcomment
    {
        public static void addQComment(int Qcode, string user, string comment, int QCcode)
        {
            string com = "insert into Qcomment (Qcode,Username,comment,QCcode) VALUES (" + Qcode + ",'" + user + "','" + comment + "'," + QCcode + ")";
