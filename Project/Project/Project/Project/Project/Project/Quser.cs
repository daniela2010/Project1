...
namespace Project
{
    class Quser
    {
        public static void addQuestion(string User, int day, string Question, int Scode)
        {
            string com = "insert into Quser (Username,Day,Question,Scode) VALUES (" + User + ",'" + day + "','" + Question + "'," + Scode + ")";
